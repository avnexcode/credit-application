...
export const CreateGuarantorFormInner = ({
  ...
  const form = useFormContext<CreateGuarantorFormSchema>();
  const { InputText, InputStringNumber, InputDate } =
    useFormInput<CreateGuarantorFormSchema>();
  ...
  return (
    ...
    >
      ...
      <InputSelect<CreateGuarantorFormSchema, "gender">
        name="gender"
      ...
      <InputStringNumber
        ...
        required
      />
      <SelectCustomerForm<CreateGuarantorFormSchema>
        name="customerId"
        label={t("models.customer.title")}
        required
      />
      <InputSelect<CreateGuarantorFormSchema, "relationship">
        name="relationship"
      ...
      <InputText
        ...
        required
      />
      <InputSelect<CreateGuarantorFormSchema, "maritalStatus">
        name="maritalStatus"
      ...
      />
      <InputSelect<CreateGuarantorFormSchema, "employmentType">
        name="employmentType"
