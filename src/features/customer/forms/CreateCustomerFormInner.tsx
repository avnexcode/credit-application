...
export const CreateCustomerFormInner = ({
  ...
  const { InputText, InputStringNumber, InputDate } =
    useFormInput<CreateCustomerFormSchema>();
  ...
  return (
    ...
    >
      ...
      <InputSelect<CreateCustomerFormSchema, "gender">
        name="gender"
      ...
      <InputSelect<CreateCustomerFormSchema, "maritalStatus">
        name="maritalStatus"
      ...
      />
      <InputSelect<CreateCustomerFormSchema, "employmentType">
        name="employmentType"
