...
type CreateAdminFormInnerProps = {
  formId: string;
  onSubmit: (values: CreateAdminFormSchema) => void;
};

export const CreateAdminFormInner = ({
  formId,
  onSubmit,
}: CreateAdminFormInnerProps) => {
  const { t } = useTranslation();
  const form = useFormContext<CreateAdminFormSchema>();
  const { InputText, InputStringNumber, InputDate } =
    useFormInput<CreateAdminFormSchema>();
  ...
  return (
    ...
    >
      ...
      <InputSelect<CreateAdminFormSchema, "gender">
        name="gender"
      ...
      <InputSelect<CreateAdminFormSchema, "maritalStatus">
        name="maritalStatus"
