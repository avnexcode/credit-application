...
type CreateInterviewQuestionFormInnerProps = {
  formId: string;
  onSubmit: (values: CreateInterviewQuestionFormSchema) => void;
};

export const CreateInterviewQuestionFormInner = ({
  formId,
  onSubmit,
}: CreateInterviewQuestionFormInnerProps) => {
  const { t } = useTranslation();
  const form = useFormContext<CreateInterviewQuestionFormSchema>();
  const { InputText, InputStringNumber } =
    useFormInput<CreateInterviewQuestionFormSchema>();
  ...
  return (
    ...
    >
      ...
      />
      <InputSelect<CreateInterviewQuestionFormSchema, "questionType">
        name="questionType"
      ...
      />
      <InputSelect<CreateInterviewQuestionFormSchema, "isRequired">
        name="isRequired"
      ...
      />
      <InputSelect<CreateInterviewQuestionFormSchema, "isActive">
        name="isActive"
      ...
      />
      <InputSelect<CreateInterviewQuestionFormSchema, "category">
        name="category"
