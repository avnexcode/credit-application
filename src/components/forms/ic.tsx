...
type InputCurrencyProps<T extends FieldValues> = Omit<
...
const InputCurrencyInner = <T extends FieldValues>(
  {
    name,
    label,
    required,
...
export const InputCurrency = forwardRef(InputCurrencyInner) as <
  T extends FieldValues,
>(
  props: InputCurrencyProps<T> & { ref?: React.ForwardedRef<HTMLInputElement> },
) => React.ReactElement;
